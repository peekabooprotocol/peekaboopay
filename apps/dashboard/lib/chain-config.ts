...
export const CHAIN_CONFIGS: Record<number, ChainConfig> = {
	...
	964: {
		...
		adapter: "bittensor",
		accentColor: "#00e5b4",
		shieldedPoolAddress: "0xaf243B3bFc7D4cbD0e58fA175876fF51f7097f59",
	...
	8453: {
		name: "Base",
		shortName: "Base",
		adapter: "bittensor", // Will use our own ShieldedPool contracts once deployed
		accentColor: "#0052FF",
		nativeToken: {
			address: ZERO_ADDRESS,
			symbol: "ETH",
		...
		tokens: [
			{ address: ZERO_ADDRESS, symbol: "ETH", decimals: 18, name: "Ether", isNative: true },
			{ address: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", symbol: "USDC", decimals: 6, name: "USD Coin", isNative: false },
		],
	},
};
